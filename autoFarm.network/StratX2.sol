...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isCAKEStaking; // only for staking CAKE using pancakeswap's native CAKE staking contract. //initially false
    bool public isSameAssetDeposit;  //initially false
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-AUTO staking vault. //initially true

    address public farmContractAddress; // address of farm, eg, PCS, Thugs etc.
    uint256 public pid; // pid of pool in farmContractAddress
    address public wantAddress;  // lp token address 
    address public token0Address;
    address public token1Address;
    address public earnedAddress;   // ABC token address
    address public uniRouterAddress; // uniswap, pancakeswap etc ,see earn()

    address public wbnbAddress; 
    address public autoFarmAddress; // AutoFarm2 address
